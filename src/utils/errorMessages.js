...
export const getReadableErrorMessage = (error, fallback, options = {}) => {
  ...
  if (includesAny(code, ['quota_exceeded'])) {
    return withPeriod(clean || (language === 'en' ? 'Requested quantity exceeds your remaining quota.' : 'الكمية المطلوبة أكبر من الكوتا المتبقية لك.'));
  }
