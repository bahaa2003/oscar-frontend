              ...
              <TableRow key={entry.id}>
                <TableCell>
                  <div className="flex items-center gap-3">
                    <img src={resolveUserAvatar(entry, entry.name || entry.email || 'OSCAR User')} alt={entry.name} loading="lazy" decoding="async" referrerPolicy="no-referrer" className="h-8 w-8 rounded-full bg-gray-200 object-cover" />
                    <div>
