...
const AdminSuppliers = () => {
  ...
  return (
    <div className="min-w-0 space-y-4" dir={dir}>
      ...
      <section className="overflow-hidden rounded-[1.35rem] border border-fuchsia-200/70 bg-[radial-gradient(circle_at_top_left,rgba(217,70,239,0.16),transparent_34%),linear-gradient(135deg,rgba(255,255,255,0.96),rgba(250,245,255,0.92))] p-3 shadow-[0_24px_70px_-46px_rgba(147,51,234,0.55)] dark:border-fuchsia-500/20 dark:bg-[radial-gradient(circle_at_top_left,rgba(217,70,239,0.16),transparent_36%),linear-gradient(135deg,rgba(17,24,39,0.96),rgba(30,27,75,0.82))]">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          ...
          <Button
            ...
            className="h-10 shrink-0 rounded-xl bg-gradient-to-r from-violet-700 via-fuchsia-600 to-purple-500 px-4 text-white shadow-[0_18px_38px_-24px_rgba(217,70,239,0.8)] hover:brightness-105"
          >
        ...
        <div className="mt-3 grid grid-cols-1 gap-2.5 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
          <Input
            ...
            variant="search"
            className="h-11 rounded-xl border-fuchsia-200/80 bg-white/82 text-sm shadow-none focus:shadow-none dark:border-fuchsia-500/20 dark:bg-gray-950/38"
          />
          <div className="rounded-xl border border-fuchsia-200/70 bg-white/70 px-3 py-2 text-xs font-bold text-fuchsia-800 dark:border-fuchsia-500/20 dark:bg-white/[0.06] dark:text-fuchsia-100">
            {allProductsLoaded
        ...
        {allProductsLoaded ? (
          <div className="mt-3 overflow-hidden rounded-[1rem] border border-fuchsia-200/70 bg-white/80 dark:border-fuchsia-500/20 dark:bg-gray-950/26">
            {allProductsLoading ? (
              <div className="flex items-center justify-center gap-2 px-4 py-8 text-sm font-semibold text-fuchsia-700 dark:text-fuchsia-100">
                <RefreshCw className="h-4 w-4 animate-spin" />
                جاري جلب منتجات الموردين...
              </div>
            ) : filteredAllSupplierProducts.length ? (
              <div className="max-h-[27rem] divide-y divide-fuchsia-100/80 overflow-y-auto dark:divide-fuchsia-500/10">
                {filteredAllSupplierProducts.map((product) => (
                  <div
                    key={`${product.supplierId}-${product.externalProductId}`}
                    className="grid grid-cols-1 gap-2 px-3 py-2.5 text-start transition hover:bg-fuchsia-50/70 md:grid-cols-[minmax(0,1.4fr)_130px_minmax(0,0.75fr)] md:items-center dark:hover:bg-fuchsia-500/8"
                  >
                    <div className="min-w-0">
                    ...
                    <div className="min-w-0 md:text-end">
                      <p className="truncate text-xs font-black text-fuchsia-800 dark:text-fuchsia-100">{product.supplierName}</p>
