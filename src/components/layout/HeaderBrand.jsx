...
const HeaderBrand = ({ className, iconClassName, textClassName }) => (
  <span className={cn('inline-flex items-center gap-1 mr-4 min-[380px]:gap-2 min-[380px]:mr-6 sm:mr-0 sm:gap-5', className)}>
    ...
    <BrandMark
      ...
      showCaption={false}
      className={cn(
        'scale-[0.55] origin-left min-[380px]:scale-[0.75] sm:scale-[1.04]',
        iconClassName
      )}
    />
  </span>
