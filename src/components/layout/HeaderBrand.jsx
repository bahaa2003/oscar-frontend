...
const HeaderBrand = ({ className, iconClassName, textClassName }) => (
  <span className={cn('inline-flex items-center gap-1 min-[380px]:gap-2 sm:gap-5', className)}>
    ...
    <BrandMark
      ...
      showCaption={false}
      className={cn(
        'scale-[0.55] origin-left -mr-4 min-[380px]:scale-[0.75] min-[380px]:-mr-2 sm:scale-[1.04] sm:mr-0',
        iconClassName
      )}
    />
  </span>
